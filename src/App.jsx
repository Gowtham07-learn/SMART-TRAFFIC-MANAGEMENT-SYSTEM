          ...
          <Route path="/*" element={
            <DashboardLayout>
              <Routes>
                ...
                <Route path="/alerts" element={<ProtectedRoute allowedRoles={[ROLES.CITIZEN]}><Placeholder name="Alerts" /></ProtectedRoute>} />
                <Route path="/report" element={<ProtectedRoute allowedRoles={[ROLES.CITIZEN]}><Placeholder name="Report Incident" /></ProtectedRoute>} />
                <Route path="/routes" element={<ProtectedRoute allowedRoles={[ROLES.CITIZEN]}><Placeholder name="Route Recommendations" /></ProtectedRoute>} />
              </Routes>
            </DashboardLayout>
          } />
        </Routes>
